...
function generateSignature(timestamp, secret) {
    const key = `${timestamp}\n${secret}`;
    const sign = crypto_1.default.createHmac('sha256', key).update('').digest('base64');
    return sign;
}
...
const robot_1 = __nccwpck_require__(4981);
function run() {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.createTextMessage = exports.FRobot = void 0;
const got_1 = __importDefault(__nccwpck_require__(3061));
const core = __importStar(__nccwpck_require__(2186));
const crypto_1 = __nccwpck_require__(614);
class FRobot {
    constructor(uuid, versionStr, secret) {
        let version;
        if (!versionStr) {
            version = 2;
        }
 ...
 */
function generateTimestampMatch() {
